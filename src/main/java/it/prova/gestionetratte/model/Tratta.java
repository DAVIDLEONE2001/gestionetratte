...
public class Tratta {
	...
	public Tratta(Long id, String codice, String descrizione, LocalDate data, LocalDateTime oraDecollo,
			LocalDateTime oraAtterraggio, StatoTratta stato, Airbus airbus) {
		super();
		this.id = id;
		this.codice = codice;
	...
	public Tratta(String codice, String descrizione, LocalDate data, LocalDateTime oraDecollo,
			LocalDateTime oraAtterraggio, StatoTratta stato, Airbus airbus) {
		super();
		this.codice = codice;
		this.descrizione = descrizione;
